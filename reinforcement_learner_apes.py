...
xml_name = 'WA_Huge30m_2Jan2024b'  # Do not include .xml extension in this name
...
weights = [nse_weight, r2_weight, summer_nse_weight, soar_weight]
...
default_nse_summer_dict = calculate_nse_summer(default_data)
default_soar_dict = calculate_soar(default_data)
default_results = [default_nse_dict, default_r2_dict, default_nse_summer_dict, default_soar_dict]

for metric, dict in zip(['nse', 'r2', 'nse_summer', 'soar'], default_results):
...
results_nse_summer_dict = calculate_nse_summer(simulated_data)
results_soar_dict = calculate_soar(simulated_data)
results = [results_nse_dict, results_r2_dict, results_nse_summer_dict, results_soar_dict]
...
print(f'End spin-up year had NSE = {results_nse_dict[end_spinup_year]}, '
      'R^2 = {results_r2_dict[end_spinup_year]}, '
      'Summertime NSE = {results_nse_summer_dict[end_spinup_year]}, '
      'and corrected SOAR = {results_soar_dict[end_spinup_year]}, '
      'for an APES score of {apes_score}.')
